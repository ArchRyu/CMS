    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="example-nav-collapse">
          ...
          <button type="submit" class="btn btn-success navbar-right navbar-btn"><span class="normalFont"><strong>Admin
        ...
        <div class="col-sm-4" style="border:2px solid gray;padding:50px;">
          ...
          <form action="updatePwd.php" method="POST">
            <div class="form-group">
              ...
              <button type="submit" class="btn btn-block span btn-primary "> <span
                  class="glyphicon glyphicon-ok"></span> Change Password</button>
            </div>
          </form>
        </div>
        <div class="col-sm-4"></div>
